...
namespace GDT {
	...
	void init() {
		...
		// Kernel Code 64
	//	set_gate(1, 0xFFFF, 0x00af9a00, 0x9A, 0xA0);
	//	// Kernel Data 64
	//	set_gate(2, 0xFFFF, 0x00af9200, 0x92, 0xCF);
	//	// User Code 64
	//	set_gate(3, 0xFFFF, 0x008ff200, 0xFA, 0xA0);
	//	// User Data 64
	//	set_gate(4, 0xFFFF, 0x00affa00, 0xF2, 0xCF);
		//TSS
